...
c.eq.s $f4, $f6  # if (xA == xB)
bc1t a_eq_b      #     goto a_eq_b

c.eq.s $f4, $f8  # if (xA == xC)
bc1t chose_a_b   #     goto chose_a_b

c.eq.s $f6, $f8  # if (xB == xC)
bc1t chose_a_b   #     goto chose_a_b
...
a_eq_b:
      ...
      c.eq.s $f4, $f8 # if (xA == xC)
      bc1t chose_a    # it doesn't matter

      c.lt.s $f4, $f8 # if (xA < xC)
      bc1t chose_c
      j chose_a

chose_a_b:
      # compare a and b get bigger
      c.lt.s $f4, $f6 # if (xA < xB)
      bc1t chose_b
      j chose_a
